...
📦 Portfolio Collection
 ┣ 📂 PortfolioBasicHTMLCSSJavascript
 ┣ 📂 PortfolioAdvancedHTMLCSSJavascript
 ┗ 📂 PortfolioReactBased
...
| Feature            | Basic        | Advanced       | React Version        |
|------------------|-------------|---------------|----------------------|
| Technology       | HTML/CSS    | HTML/CSS/JS   | React + Tailwind     |
| UI Complexity    | Simple      | Medium        | Advanced             |
| Interactivity    | Low         | Medium        | High                 |
| Structure        | Static      | Section-based | Component-based      |
